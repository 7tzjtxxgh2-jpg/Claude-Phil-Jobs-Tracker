...
**Corpus size at this writing:** 267 jobs
**Vocabulary size eligible for synonym lookup:** 2663 terms
...
- **2026-08-03**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-08-03**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-08-03**: Taxonomy revised to add four subcategories from a
...
- **2026-08-03**: Bubble chart rewritten to source from the Claude-
...
- **2026-08-03**: Initial documented version of the methodology.
