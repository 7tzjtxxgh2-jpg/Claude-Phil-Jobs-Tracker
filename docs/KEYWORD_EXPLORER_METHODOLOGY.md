...
**Corpus size at this writing:** 230 jobs
**Vocabulary size eligible for synonym lookup:** 2491 terms
...
- **2026-06-29**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-06-29**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-06-29**: Taxonomy revised to add four subcategories from a
...
- **2026-06-29**: Bubble chart rewritten to source from the Claude-
...
- **2026-06-29**: Initial documented version of the methodology.
