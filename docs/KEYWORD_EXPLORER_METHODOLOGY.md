...
**Corpus size at this writing:** 293 jobs
**Vocabulary size eligible for synonym lookup:** 2835 terms
...
- **2026-08-24**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-08-24**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-08-24**: Taxonomy revised to add four subcategories from a
...
- **2026-08-24**: Bubble chart rewritten to source from the Claude-
...
- **2026-08-24**: Initial documented version of the methodology.
