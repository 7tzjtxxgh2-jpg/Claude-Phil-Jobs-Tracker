...
**Corpus size at this writing:** 237 jobs
**Vocabulary size eligible for synonym lookup:** 2533 terms
...
- **2026-07-06**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-07-06**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-07-06**: Taxonomy revised to add four subcategories from a
...
- **2026-07-06**: Bubble chart rewritten to source from the Claude-
...
- **2026-07-06**: Initial documented version of the methodology.
