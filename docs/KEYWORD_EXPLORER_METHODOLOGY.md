...
**Corpus size at this writing:** 275 jobs
**Vocabulary size eligible for synonym lookup:** 2717 terms
...
- **2026-08-17**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-08-17**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-08-17**: Taxonomy revised to add four subcategories from a
...
- **2026-08-17**: Bubble chart rewritten to source from the Claude-
...
- **2026-08-17**: Initial documented version of the methodology.
