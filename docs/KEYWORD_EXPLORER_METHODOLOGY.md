...
**Corpus size at this writing:** 207 jobs
**Vocabulary size eligible for synonym lookup:** 2234 terms
...
- **2026-06-01**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-06-01**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-06-01**: Taxonomy revised to add four subcategories from a
...
- **2026-06-01**: Bubble chart rewritten to source from the Claude-
...
- **2026-06-01**: Initial documented version of the methodology.
