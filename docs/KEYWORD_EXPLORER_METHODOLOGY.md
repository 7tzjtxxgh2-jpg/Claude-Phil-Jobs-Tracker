...
**Corpus size at this writing:** 208 jobs
**Vocabulary size eligible for synonym lookup:** 2245 terms
...
- **2026-06-09**: Added semi-annual Opus QC check. Twice a year
  ...
  bounded.
- **2026-06-09**: Switched Claude model from `claude-haiku-4-5-20251001`
...
- **2026-06-09**: Taxonomy revised to add four subcategories from a
...
- **2026-06-09**: Bubble chart rewritten to source from the Claude-
...
- **2026-06-09**: Initial documented version of the methodology.
